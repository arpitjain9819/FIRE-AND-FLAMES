...
#define HIDIOCGF_WDATASIZE(len)		_IOC(_IOC_WRITE|_IOC_READ, 'H', 0x08, len)

/* ioctl: HID Set feature skip report id */
#define HIDIOCSF_SKIPREPID(len)		_IOC(_IOC_WRITE|_IOC_READ, 'H', 0x09, len)

/* ioctl: HID Output skip report id */
#define HIDIOCSO_SKIPREPID(len)		_IOC(_IOC_WRITE|_IOC_READ, 'H', 0x0A, len)
#endif
