...
struct fsg_lun {
	...
	struct device	dev;
	char		*lun_filename;  // 2014/3/25 hilbert-35244 [All][Main][USB][DMS05339959] Support PC Companion 
...
/*[Arima5908][46219][bozhi_lin] fix installer can't work at Mac computer 20141119 begin*/
...
#endif
/*[Arima5908][46219][bozhi_lin] 20141119 end*/
			      ...
			      const char *buf, size_t count)
{
	...
	if (fsg_lun_is_open(curlun)) {
		...
		kfree(curlun->lun_filename);  // 2014/3/25 hilbert-35244 [All][Main][USB][DMS05339959] Support PC Companion 
		curlun->lun_filename = NULL;  // 2014/3/25 hilbert-35244 [All][Main][USB][DMS05339959] Support PC Companion 
	}
